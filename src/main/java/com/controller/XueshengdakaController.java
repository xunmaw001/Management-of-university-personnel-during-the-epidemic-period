                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            xueshengdakaEntity.setDakaName(data.get(0));                    //打卡地点 要改的
                            xueshengdakaEntity.setDakaContent("");//照片
                            xueshengdakaEntity.setJiankangTypes(Integer.valueOf(data.get(0)));   //是否健康 要改的
