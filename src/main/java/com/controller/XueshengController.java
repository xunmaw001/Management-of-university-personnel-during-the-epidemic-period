...
public class XueshengController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        params.put("xueshengDeleteStart",1);params.put("xueshengDeleteEnd",1);
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            xueshengEntity.setXueshengEmail(data.get(6));                    //电子邮箱 要改的
                            xueshengEntity.setXueshengAddress(data.get(7));                    //住宅住址 要改的
                            xueshengEntity.setXueshengDelete(1);//逻辑删除字段
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                if(seachFields.containsKey("xueshengUuidNumber")){
                                    ...
                                    xueshengUuidNumber.add(data.get(1));//要改的
                                }else{
                                ...
                                if(seachFields.containsKey("xueshengPhone")){
                                    ...
                                    xueshengPhone.add(data.get(3));//要改的
                                }else{
                                ...
                                if(seachFields.containsKey("xueshengIdNumber")){
                                    ...
                                    xueshengIdNumber.add(data.get(4));//要改的
                                }else{
                        ...
                        //查询是否重复
                         //账户
                        List<XueshengEntity> xueshengEntities_username = xueshengService.selectList(new EntityWrapper<XueshengEntity>().in("username", seachFields.get("username")).eq("xuesheng_delete", 1));
                        if(xueshengEntities_username.size() >0 ){
                         ...
                         //学号
                        List<XueshengEntity> xueshengEntities_xueshengUuidNumber = xueshengService.selectList(new EntityWrapper<XueshengEntity>().in("xuesheng_uuid_number", seachFields.get("xueshengUuidNumber")).eq("xuesheng_delete", 1));
                        if(xueshengEntities_xueshengUuidNumber.size() >0 ){
                         ...
                         //学生手机号
                        List<XueshengEntity> xueshengEntities_xueshengPhone = xueshengService.selectList(new EntityWrapper<XueshengEntity>().in("xuesheng_phone", seachFields.get("xueshengPhone")).eq("xuesheng_delete", 1));
                        if(xueshengEntities_xueshengPhone.size() >0 ){
                         ...
                         //学生身份证号
                        List<XueshengEntity> xueshengEntities_xueshengIdNumber = xueshengService.selectList(new EntityWrapper<XueshengEntity>().in("xuesheng_id_number", seachFields.get("xueshengIdNumber")).eq("xuesheng_delete", 1));
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        else if(xuesheng.getXueshengDelete() != 1)
