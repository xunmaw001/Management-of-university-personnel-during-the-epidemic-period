                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            laoshiEntity.setLaoshiName(data.get(1));                    //老师姓名 要改的
                            laoshiEntity.setLaoshiPhone(data.get(2));                    //老师手机号 要改的
                            laoshiEntity.setLaoshiIdNumber(data.get(3));                    //老师身份证号 要改的
                            laoshiEntity.setLaoshiPhoto("");//照片
                            laoshiEntity.setSexTypes(Integer.valueOf(data.get(4)));   //性别 要改的
                            laoshiEntity.setLaoshiEmail(data.get(5));                    //电子邮箱 要改的
                            laoshiEntity.setLaoshiAddress(data.get(6));                    //住宅住址 要改的
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                if(seachFields.containsKey("laoshiPhone")){
                                    ...
                                    laoshiPhone.add(data.get(2));//要改的
                                }else{
                                ...
                                if(seachFields.containsKey("laoshiIdNumber")){
                                    ...
                                    laoshiIdNumber.add(data.get(3));//要改的
                                }else{
                        ...
                        if(laoshiEntities_laoshiPhone.size() >0 ){
                         ...
                         //老师身份证号
                        List<LaoshiEntity> laoshiEntities_laoshiIdNumber = laoshiService.selectList(new EntityWrapper<LaoshiEntity>().in("laoshi_id_number", seachFields.get("laoshiIdNumber")).eq("laoshi_delete", 1));
