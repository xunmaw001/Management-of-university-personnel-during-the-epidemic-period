...
public class LaoshifanxiaoView extends LaoshifanxiaoEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 是否同意的值
		*/
		private String laoshifanxiaoYesnoValue;
	...
	public LaoshifanxiaoView() {

	}

	public LaoshifanxiaoView(LaoshifanxiaoEntity laoshifanxiaoEntity) {
		try {
			BeanUtils.copyProperties(this, laoshifanxiaoEntity);
			...
			* 获取： 是否同意的值
			*/
			public String getLaoshifanxiaoYesnoValue() {
				return laoshifanxiaoYesnoValue;
			}
			/**
			* 设置： 是否同意的值
			*/
			public void setLaoshifanxiaoYesnoValue(String laoshifanxiaoYesnoValue) {
				this.laoshifanxiaoYesnoValue = laoshifanxiaoYesnoValue;
			}
