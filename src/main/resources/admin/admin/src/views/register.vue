    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">疫情期间高校人员管理注册</h1>
                <el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
                        ...
                        <el-form-item label="操作人员姓名" class="input" v-if="tableName=='caozuorenyuan'">
                            <el-input v-model="ruleForm.caozuorenyuanName" autocomplete="off" placeholder="操作人员姓名"  />
                        </el-form-item>
                        <el-form-item label="操作人员身份证号" class="input" v-if="tableName=='caozuorenyuan'">
                            <el-input v-model="ruleForm.caozuorenyuanIdNumber" autocomplete="off" placeholder="操作人员身份证号"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.caozuorenyuanIdNumber)&& 'caozuorenyuan'==this.tableName){
