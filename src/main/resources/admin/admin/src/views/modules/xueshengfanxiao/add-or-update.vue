...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    xueshengfanxiaoYesnoTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                    fanxiaoTime: '',
                    fanxiaoContent: '',
                    xueshengfanxiaoYesnoTypes: '',
                    insertTime: '',
                },
                xueshengfanxiaoYesnoTypesOptions : [],
                xueshengOptions : [],
                rules: {
                   xueshengId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengfanxiao_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengfanxiaoYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='xueshengfanxiaoYesnoTypes'){
                          this.ruleForm.xueshengfanxiaoYesnoTypes = obj[o];
                          this.ro.xueshengfanxiaoYesnoTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xueshengfanxiao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xueshengfanxiaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
