    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="预计返校时间" prop="fanxiaoTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.fanxiaoTime" label="预计返校时间" prop="fanxiaoTime">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    fanxiaoTime: '',
                    fanxiaoContent: '',
                    laoshifanxiaoYesnoTypes: '',
                    insertTime: '',
                },
                laoshifanxiaoYesnoTypesOptions : [],
                laoshiOptions : [],
                rules: {
                   laoshiId: [
                   ...
                   fanxiaoTime: [
                              { required: true, message: '预计返校时间不能为空', trigger: 'blur' },
                          ],
                   fanxiaoContent: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=laoshifanxiao_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.laoshifanxiaoYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='laoshifanxiaoYesnoTypes'){
                          this.ruleForm.laoshifanxiaoYesnoTypes = obj[o];
                          this.ro.laoshifanxiaoYesnoTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`laoshifanxiao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.laoshifanxiaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
