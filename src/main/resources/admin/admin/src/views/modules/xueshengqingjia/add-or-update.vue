...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengqingjia_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengqingjiaYesnoTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='xueshengqingjiaYesnoTypes'){
                          this.ruleForm.xueshengqingjiaYesnoTypes = obj[o];
                          this.ro.xueshengqingjiaYesnoTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
