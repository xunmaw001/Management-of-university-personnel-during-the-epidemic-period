               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="住宅住址" prop="laoshiAddress">
                       <el-input v-model="ruleForm.laoshiAddress"
                                 placeholder="住宅住址" clearable  :readonly="ro.laoshiAddress"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   laoshiAddress: [
                              { required: true, message: '住宅住址不能为空', trigger: 'blur' },
                          ],
                   laoshiDelete: [
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='laoshiAddress'){
                          this.ruleForm.laoshiAddress = obj[o];
                          this.ro.laoshiAddress = true;
                          continue;
                      }
                      if(o=='laoshiDelete'){
                          this.ruleForm.laoshiDelete = obj[o];
                          this.ro.laoshiDelete = true;
                          continue;
                      }
                    }
                }
