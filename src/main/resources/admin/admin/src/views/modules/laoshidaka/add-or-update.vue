    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="打卡地点" prop="dakaName">
                       <el-input v-model="ruleForm.dakaName"
                                 placeholder="打卡地点" clearable  :readonly="ro.dakaName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="打卡地点" prop="dakaName">
                           <el-input v-model="ruleForm.dakaName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否健康" prop="jiankangTypes">
                        <el-select v-model="ruleForm.jiankangTypes" placeholder="请选择是否健康">
                            <el-option
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='dakaName'){
                          this.ruleForm.dakaName = obj[o];
                          this.ro.dakaName = true;
                          continue;
                      }
                      if(o=='dakaContent'){
                          this.ruleForm.dakaContent = obj[o];
                          this.ro.dakaContent = true;
                          continue;
                      }
                      if(o=='jiankangTypes'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`laoshidaka/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.laoshidakaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
