<template>
  <div>
    ...
    >  
     <el-row>
                                     <el-col :span="12">
                              <el-form-item v-if="flag=='caozuorenyuan'"  label='操作人员姓名' prop="caozuorenyuanName">
                                  <el-input v-model="ruleForm.caozuorenyuanName"  placeholder='操作人员姓名' clearable></el-input>
                              </el-form-item>
                          </el-col>

                          <el-col :span="12">
                              <el-form-item v-if="flag=='caozuorenyuan'"  label='操作人员电话' prop="caozuorenyuanPhone">
                                  <el-input v-model="ruleForm.caozuorenyuanPhone"  placeholder='操作人员电话' clearable></el-input>
                              </el-form-item>
                          </el-col>

                          <el-col :span="12">
                              <el-form-item v-if="flag=='caozuorenyuan'"  label='操作人员身份证号' prop="caozuorenyuanIdNumber">
                                  <el-input v-model="ruleForm.caozuorenyuanIdNumber"  placeholder='操作人员身份证号' clearable></el-input>
                              </el-form-item>
                          </el-col>

                        <el-col :span="24">
                            <el-form-item v-if="flag=='caozuorenyuan'" label='操作人员头像' prop="caozuorenyuanPhoto">
                                <file-upload
                                        tip="点击上传照片"
                                        action="file/upload"
                                        :limit="3"
                        ...
                        <el-col :span="24">
                          ...
                          <el-col :span="12">
                              <el-form-item v-if="flag=='laoshi'"  label='住宅住址' prop="laoshiAddress">
                                  <el-input v-model="ruleForm.laoshiAddress"  placeholder='住宅住址' clearable></el-input>
                              </el-form-item>
                          </el-col>
                        ...
                        <el-col :span="24">
                          ...
                          <el-col :span="12">
                              <el-form-item v-if="flag=='xuesheng'"  label='住宅住址' prop="xueshengAddress">
                                  <el-input v-model="ruleForm.xueshengAddress"  placeholder='住宅住址' clearable></el-input>
                              </el-form-item>
                          </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.caozuorenyuanName)&& 'caozuorenyuan'==this.flag){
                             this.$message.error('操作人员姓名不能为空');
                             return
                         }

                         if((!this.ruleForm.caozuorenyuanPhone)&& 'caozuorenyuan'==this.flag){
                             this.$message.error('操作人员电话不能为空');
                             return
                         }

                         if((!this.ruleForm.caozuorenyuanIdNumber)&& 'caozuorenyuan'==this.flag){
                             this.$message.error('操作人员身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.caozuorenyuanPhoto)&& 'caozuorenyuan'==this.flag){
                             this.$message.error('操作人员头像不能为空');
                             return
                         }
